...
public class ActionBarContextView extends AbsActionBarView implements AnimatorListener {
	...
	public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN){
        	setBackground(a.getDrawable(R.styleable.SherlockActionMode_background));
        }
        else setBackgroundDrawable(a.getDrawable(R.styleable.SherlockActionMode_background));
        ...
        if (mSplitActionBar != split) {
            if (mActionMenuPresenter != null) {
                ...
                if (!split) {
                    ...
                    else mMenuView.setBackgroundDrawable(null);
                    ...
                    else mMenuView.setBackgroundDrawable(mSplitBackground);
                    final ViewGroup oldParent = (ViewGroup) mMenuView.getParent();
                    if (oldParent != null) oldParent.removeView(mMenuView);
