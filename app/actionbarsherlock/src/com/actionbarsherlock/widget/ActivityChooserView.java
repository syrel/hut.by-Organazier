...
class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
	...
	public boolean dismissPopup() {
        if (isShowingPopup()) {
            ...
            if (viewTreeObserver.isAlive()) {
            	...
            	else viewTreeObserver.removeGlobalOnLayoutListener(mOnGlobalLayoutListener);
            }
        }
        return true;
    }
	...
	private void updateAppearance() {
        ...
        if (mDefaultActivityButton.getVisibility() == VISIBLE) {
        	...
        	else mActivityChooserContent.setBackgroundDrawable(mActivityChooserContentBackground);
        } else {
        	if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN){
        		mActivityChooserContent.setBackground(null);
        	}
        	else mActivityChooserContent.setBackgroundDrawable(null);
