...
public class TextTableRow extends TableRow{
	...
	public TextTableRow(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public TextTableRow setPadding(float dp){
	...
	public TextTableRow setBorderWidth(float dp){
	...
	public TextTableRow setTextSize(float sp){
		this.textSize = sp;
		for (TextView textView : columns){
			textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, textSize);
		}
	...
	public TextTableRow setTextColor(int color){
	...
	public TextTableRow setBold(boolean bold){
		this.bold = bold;
		for (TextView textView : columns){
