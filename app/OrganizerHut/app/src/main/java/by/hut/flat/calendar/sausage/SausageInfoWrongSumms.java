...
public class SausageInfoWrongSumms extends Info{
	
	private Context context;
	private DBAdapter db;
	private Payment paymentDB;
	
	public SausageInfoWrongSumms(Context context) {
		super(context);
	...
	private void init(){
		final int[][] pData = paymentDB.getWrongSumms();
		...
		this.setInfoText(pData.length + " " + Utils.getString(context, R.string.sausage_infobar_summs));
