...
public class SausageInfoWrongPayments extends Info{
	
	private Context context;
	private DBAdapter db;
	private Payment paymentDB;
	
	public SausageInfoWrongPayments(Context context) {
		super(context);
	...
	private void init(){
		final int[][] pData = paymentDB.getWrongPayments();
		...
		this.setInfoText(pData.length + " " + Utils.getString(context, R.string.sausage_infobar_payment));
