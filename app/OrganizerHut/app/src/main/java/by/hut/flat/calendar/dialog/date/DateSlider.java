...
import by.hut.flat.calendar.dialog.date.SliderContainer.OnTimeChangeListener;
...
public class DateSlider extends Dialog {
	 ...
	 */
	 ...
	 public void onCreate(Bundle savedInstanceState) {
		 ...
		 this.getWindow().setBackgroundDrawableResource(R.drawable.dialog_full_holo_dark);
	 ...
	 protected void setTitle() {
		 if (mTitleText != null) {
			 ...
			 mTitleText.setText(getContext().getString(R.string.dialog_datetime_title) +
