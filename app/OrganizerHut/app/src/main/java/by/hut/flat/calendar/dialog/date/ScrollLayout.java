...
import by.hut.flat.calendar.widget.datetime.labeler.Labeler;
...
public class ScrollLayout extends LinearLayout {
    ...
    public ScrollLayout(Context context, AttributeSet attrs) {
        ...
        rightShadow = getContext().getResources().getDrawable(R.drawable.dialog_datetime_right_shadow);
        leftShadow = getContext().getResources().getDrawable(R.drawable.dialog_datetime_left_shadow);
