...
public class SausageInfoMissPhone extends Info{

	private Context context;
	private DBAdapter db;
	private IntervalAnketa intervaAnketalDB;
	
	public SausageInfoMissPhone(Context context) {
		super(context);
	...
	private void init(){
		final int[] intervalIDs = intervaAnketalDB.getIntervalIDsMissPhone();
		...
		this.setInfoText(intervalIDs.length + " " + Utils.getString(context, R.string.sausage_infobar_phone));
