...
public class SausageInfoMissPhoneName extends Info{

	private Context context;
	private DBAdapter db;
	private IntervalAnketa intervaAnketalDB;
	
	public SausageInfoMissPhoneName(Context context) {
		super(context);
	...
	private void init(){
		final int[] intervalIDs = intervaAnketalDB.getIntervalIDsMissPhoneName();
		...
		this.setInfoText(intervalIDs.length + " " + Utils.getString(context, R.string.sausage_infobar_phone_name));
